...
<body>
  <!-------------header image-------------->
  <div class="header">
    <img src="compbg.png" height="150px" width="1400px" alt="nature" class="responsive">
  </div>
...
<script>VanillaTilt.init(document.querySelectorAll(".eventcard"), {
  max: 25,
  speed: 400,
  glare: true,
  "max-glare": 1,
...
<div class="eventcon">
  <div class="eventcard">
    <div class="data">
      ...
      <p>Technical events serve as a stage for students to showcase their talents and innovations. Whether presenting projects or participating in competitions, students refine their communication and presentation skills. Active participation in these events enhances their resumes, demonstrating a commitment to continuous learning and skill developmen</p>
    </div>
  </div>
  <div class="eventcard">
    <div class="data">
      ...
      <p>Non-technical events also foster a sense of community and belonging. Participation in events that align with personal interests and passions helps students connect with like-minded peers. This sense of belonging contributes to a positive college environment and encourages a supportive community spirit</p>
    </div>
  </div>
  <div class="eventcard">
    <div class="data">
      <h2>03</h2>
      <h3>Techonolgy centric events</h3>
      <p>Hackathons and bootcamps focusing on today's technology are incredibly valuable in today's fast-paced and dynamic technological landscape. These immersive and intensive learning experiences provide a unique and effective approach to skill development and problem-solving</p>
    </div>
  </div>
</div>
</section>
