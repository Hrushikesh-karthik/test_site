...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $phone = htmlspecialchars($row["years"]);
...
<body>
    <div class="my-5">
        <h2>New student</h2>
        <a class='btn btn-primary btn-sm' href="admin.php" role="button" style="background-color:green; width:100px; font-size:20px">Back</a>
        <?php
        ...
        <form method="post" >
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Transcation ID</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="years" value="<?php echo $phone;?>">
                </div>
            </div>
            <div class="row mb-3">
